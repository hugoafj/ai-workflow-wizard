...
description: "Use CodeGraph for structural/codebase questions about project architecture, dependencies, and call flows"
applyTo: "**"
---
...
- Create Git worktrees that may need CodeGraph under your home directory, preferably as a sibling such as `<repo-parent>/<repo-name>-worktrees/<worktree-name>`. Never place a CodeGraph-dependent worktree under `/tmp`, `/var/tmp/`, or `/tmp/opencode`; generic temporary-work guidance does not override this rule.
